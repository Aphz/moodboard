...
- **Dibujo** con lápiz, línea, flecha, rectángulo y elipse; presión de Apple Pencil; opacidad por dibujo. El Pencil dibuja directamente, sin cambiar de herramienta (el dedo sigue seleccionando y moviendo el lienzo), los trazos seguidos y cercanos se acumulan en una sola anotación, y mientras trazas la escena se congela para que el trazo no se atrase. Una anotación se toca donde está la tinta: entre las letras el toque pasa a la imagen que hay debajo. Lo mismo con los símbolos y las notas sin fondo, que se tocan sobre el texto y no en todo su rectángulo, y con las imágenes recortadas: si pegas un sujeto recortado con la función de stickers de iOS, el toque atraviesa su fondo vacío y no se le dibuja el borde que delataría el recorte.
